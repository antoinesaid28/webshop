    ...
    <div class="container"><a class="navbar-brand" href="index.php"><img
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown" style="margin: 5px;"><a class="dropdown-toggle nav-link"
...
<section class="login-dark" style="background: rgba(71,93,98,0);">
    ...
    <form method="post" action="conexion.php"><h2 class="visually-hidden">Login Form</h2>
